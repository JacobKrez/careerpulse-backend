...
// Security middleware
app.use(helmet());
app.use(cors({ origin: 'https://careerpulseai.netlify.app' }));
...
const limiter = rateLimit({
  ...
  message: 'You have exceeded the request limit (200 requests per 15 minutes). Please try again later or contact support.',
});
app.use(limiter);
